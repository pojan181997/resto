...
<div>
    <h2>Data Pesanan</h2>
    <a href="data_pesanan.php?add" class="btn-add"><button>Tambah Pesanan</button></a>
    ...
    <table border="1">
        ...
        <?php while ($row = $DataPesanan->fetch_assoc()): ?>
            <tr>
                ...
                <td>
                    <a href="data_pesanan.php?edit=<?= $row['id_pesanan']; ?>">Edit</a>
                    <a href="data_pesanan.php?delete=<?= $row['id_pesanan']; ?>" onclick="return confirm('Yakin ingin menghapus pesanan ini?')">Hapus</a>
                </td>
            </tr>
        <?php endwhile; ?>
        </tbody>
...
<div class="overlay" id="popup">
    <div class="popup">
        <a href="data_pesanan.php" class="close">&times;</a>
...
<input type="number" id="harga_satuan" name="harga_satuan" value="<?= htmlspecialchars($harga_satuan ?? ''); ?>" readonly required>
            ...
            <a href="data_pesanan.php" class="cancel-button">Batal</a>
        </form>
    </div>
</div>
<?php endif; ?>
