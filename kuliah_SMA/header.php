    ...
    <div class="sidebar">
        ...
        <div class="dropdown">
            ...
            <div class="dropdown-content">
                <a href="crud.php">Pengguna</a>
                <a href="crud_jenisdata.php">Management Data Produk</a>
                <a href="crud_databahan.php">Management Data Bahan Baku</a>
                <a href="data_pesanan.php">  Management Pesanan</a>
                <a href="data_transaksi.php">Management Transaksi</a>
            </div>
        </div>
        <div class="dropdown">
            <button class="dropdown-btn">Data olah ▼</button>
            <div class="dropdown-content">
                <a href="hitungSMA.php">Rank</a>
            </div>
        </div>
